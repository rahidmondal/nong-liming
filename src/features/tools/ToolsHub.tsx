import { ThaiManuscriptIcon, ThaiScriptIcon, ThaiPavilionIcon, ThaiBellIcon } from '@/components/ThaiIcons';
        ...
        <motion.div variants={container} initial="hidden" animate="show" className="w-full space-y-4">
          <motion.div variants={item}>
            ...
            >
              ...
              <div className="p-3 bg-primary/10 rounded-lg text-primary mr-4">
                <ThaiManuscriptIcon className="w-8 h-8" />
              </div>
          ...
          <motion.div variants={item}>
            ...
            >
              <div className="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity" />
              <div className="p-3 bg-primary/10 rounded-lg text-primary mr-4">
                <ThaiScriptIcon className="w-8 h-8" />
              </div>
              <div className="flex-1">
          ...
          <motion.div variants={item}>
            ...
            >
              <div className="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity" />
              <div className="p-3 bg-primary/10 rounded-lg text-primary mr-4">
                <ThaiBellIcon className="w-8 h-8" />
              </div>
              <div className="flex-1">
