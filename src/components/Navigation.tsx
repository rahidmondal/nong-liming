import { ThaiTempleIcon, ThaiPavilionIcon, ThaiLotusIcon } from './ThaiIcons';
    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-t border-border pb-safe md:top-0 md:bottom-0 md:right-auto md:w-24 md:border-t-0 md:border-r md:flex md:flex-col md:justify-center">
      <div className="max-w-md mx-auto flex justify-around p-2 md:flex-col md:space-y-8 md:p-4">
        <NavLink
          ...
          className={({ isActive }) =>
            `flex flex-col items-center p-2 rounded-xl transition-colors min-w-[64px] ${isActive ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`
          }
          id="nav-tab-home"
        >
          <ThaiTempleIcon className="w-8 h-8" />
        ...
        <NavLink
          ...
          id="nav-tab-practice"
        >
          <ThaiPavilionIcon className="w-8 h-8" />
        ...
        <NavLink
          ...
          id="nav-tab-profile"
        >
          <ThaiLotusIcon className="w-8 h-8" />
